            ...
            if (EventoExists(id))
            {
                ...
                if (participantes.Any())
                {
                    foreach (var participante in participantes)
                    {
                        try
                        {
                            _emailSender.SendEmailAsync(participante.Email, "Notificação: " + evento.Nome, EmailsHelper.EmailNotificacao(evento.Nome, participante.Nome, evento.DataEvento.ToString(), "http://www.partymaker.com"));
                        }
                        catch (Exception ex)
                        {
