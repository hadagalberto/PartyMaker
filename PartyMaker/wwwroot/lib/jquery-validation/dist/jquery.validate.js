...
$.extend( $.validator, {
	...
	messages: {
		...
		remote: "Verifique o campo e tente novamente.",
		email: "Por favor, insira um email válido.",
		url: "Por favor, insira uma URL válida.",
		date: "Por favor, insira uma data válida.",
		dateISO: "Por favor, insira uma data válida (ISO).",
		number: "Por favor, insira um número válido.",
		digits: "Por favor, preencha apenas com números.",
		...
		rangelength: $.validator.format( "Por favor, preencha o campo com {0} a {1} caracteres." ),
		...
		step: $.validator.format( "Por favor, insira um valor múltiplo de {0}." )
	},
